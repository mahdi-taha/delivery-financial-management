    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1 page-title">{{ __('common.edit_payment_method') }}</h4>
                </div>
                <div>
            ...
            <hr class="thick-hr">
            <form action="{{ route('payment_methods.update', $paymentMethod->id) }}" class="w-100" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control  @error('name') border-danger @enderror"
                                    value="{{ old('name', $paymentMethod->name) }}" id="name" name="name"
