    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1 page-title">{{ __('common.add_currency') }}</h4>
                </div>
                <div>
            ...
            <hr class="thick-hr">
            <form action="{{ route('currencies.store') }}" class="w-100" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control  @error('name') border-danger @enderror"
                                    ...
                                    placeholder="{{ __('common.enter_currency_name') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control  @error('symbol') border-danger @enderror"
                                    value="{{ old('symbol') }}" id="symbol" name="symbol"
                                    placeholder="{{ __('common.enter_currency_symbol') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <select class="form-select @error('input_mode') border-danger @enderror" id="input_mode"
                                    name="input_mode">
                                    <option value="normal" {{ 'normal' == old('input_mode') ? 'selected' : '' }}>Select
                                        input mode</option>
                                    <option value="tens" {{ 'tens' == old('input_mode') ? 'selected' : '' }}>
                                        Tens
                                    </option>
                                    <option value="hundreds" {{ 'hundreds' == old('input_mode') ? 'selected' : '' }}>
                                        Hundreds
                                    </option>
                                    <option value="thousands" {{ 'thousands' == old('input_mode') ? 'selected' : '' }}>
                                        Thousands
                                    </option>
                                    <option value="millions" {{ 'millions' == old('input_mode') ? 'selected' : '' }}>
                                        Millions
                                    </option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="number" step="0.000001" min="0"
                                    ...
                                    value="{{ old('rate') }}" id="rate" name="rate" placeholder="{{ __('common.enter_exchange_rate') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="number" step="0.000001" min="0"
                                    ...
                                    value="{{ old('rounding_unit') }}" id="rounding_unit" name="rounding_unit"
                                    placeholder="{{ __('common.enter_rounding_unit') }}">
