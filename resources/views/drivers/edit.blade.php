    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1 page-title">{{ __('drivers.edit_driver') }}</h4>
                </div>
                <div>
            ...
            <hr class="thick-hr">
            <form action="{{ route('drivers.update', $driver->id) }}" class="w-100" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control  @error('name') border-danger @enderror"
                                    value="{{ old('name', $driver->name) }}" id="name" name="name">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control  @error('phone') border-danger @enderror"
                                    value="{{ old('phone', $driver->phone) }}" id="phone" name="phone">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <select class="form-select @error('driver_type') border-danger @enderror"
                                    ...
                                    <option value="fixed"
                                        {{ 'fixed' == old('driver_type', $driver->driver_type) ? 'selected' : '' }}>
                                        {{ __('common.fixed') }}
                                    </option>
                                    <option value="percentage"
                                        {{ 'percentage' == old('driver_type', $driver->driver_type) ? 'selected' : '' }}>
                                        {{ __('common.percentage') }}
                                    </option>
                                    <option value="custom"
                                        {{ 'custom' == old('driver_type', $driver->driver_type) ? 'selected' : '' }}>
                                        {{ __('drivers.custom') }}
                                    </option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="number" step="0.01" min="0"
                                    ...
                                    value="{{ old('percentage', $driver->driver_percentage) }}" id="percentage"
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input type="number" step="0.01" min="0"
                                    ...
                                    value="{{ old('salary', $driver->salary) }}" id="salary" name="salary">
